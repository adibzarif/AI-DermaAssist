<div class="ml-64 bg-[#f7f7f7] min-h-screen p-6">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <table class="w-full table-fixed">
            ...
            <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                ...
                <td class="py-4">
                    ...
                    $names = explode(',', $row['types']);
                    $ids = explode(',', $row['type_ids']);
                    ...
                    <span
                        class="bg-green-50 text-green-600 px-3 py-1 rounded-xl text-xs inline-flex items-center gap-2"
                    ...
                    >
                        ...
                        <a
                            href="index.php?action=deletePST&product_id=<?= $row['product_id'] ?>&skintype_id=<?= $tid ?>"
                            onclick="return confirm('Delete this?')"
                            class="delete-btn hidden text-red-500 font-bold"
                        >
                            ✕
                        </a>
                ...
                <td>
                    ...
                    <div class="flex justify-center gap-2">
                        ...
                        <!-- DELETE -->
                        <a
                            href="index.php?action=deletePSTRow&product_id=<?= $row['product_id'] ?>"
        ...
        <div class="flex justify-center items-center gap-3 mt-6">
            ...
            <a
                href="index.php?page=productSkinType&p=<?= $page-1 ?>&search=<?= $_GET['search'] ?? '' ?>"
            ...
            <a
                href="index.php?page=productSkinType&p=<?= $i ?>&search=<?= $_GET['search'] ?? '' ?>"
...
<!-- MODAL -->
<?php include __DIR__ . '/components/product_skintype_modal.php'; ?>