<div class="ml-64 bg-[#f7f7f7] min-h-screen p-6">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-6">
        ...
        <table class="w-full table-fixed">
            ...
            <tr class="border-b border-gray-100 hover:bg-gray-50 transition">
                ...
                <td class="py-4">
                    ...
                    $names = explode(',', $row['tones']);
                    $ids = explode(',', $row['tone_ids']);
                    ...
                    <span
                        class="bg-purple-100 text-purple-700 px-3 py-1 rounded-xl text-xs inline-flex items-center gap-2"
                    >
                ...
                <td>
                    ...
                    <div class="flex justify-center gap-2">
                        ...
                        <!-- DELETE -->
                        <a
                            href="index.php?action=deletePSToneRow&product_id=<?= $row['product_id'] ?>"
        ...
        <div class="flex justify-center items-center gap-3 mt-6">
            ...
            <a
                href="index.php?page=productSkinTone&p=<?= $page-1 ?>&search=<?= $_GET['search'] ?? '' ?>"
            ...
            <a
                href="index.php?page=productSkinTone&p=<?= $i ?>&search=<?= $_GET['search'] ?? '' ?>"
...
<!-- MODAL -->
<?php include __DIR__ . '/components/product_skintone_modal.php'; ?>